...
<div data-usuario-id="{{ $id }}" class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition duration-300 flex flex-col justify-between">
    <div>
    ...
    <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-end">
        <div class="flex gap-3 text-sm">
            ...
            <form action="{{ route('usuarios.destroy', $id) }}" method="POST" class="inline btn-eliminar-usuario">
                @method('DELETE')
